...
server_id = '192.168.53.166'
client_1 = '192.168.53.118'
client_2 = '192.168.53.134'
    ...
    def run(self):
        ...
        def AnoMad():
            ...
            #   start_time = time.time()
                x1, x2, x3 = s2.get(), s3.get(), float(rtc_device.getTemp()) #20 is the point where DS3231 i2c data is pulled
                df1 = [[1337, x1, x2, x3]]
            #   df1 = [[1337, s1.get(), s2.get(), s3.get(), s4.get()]]
                ...
                if(int(x[0])==0):
                    ...
                    An = "Anomaly in Sensor " + str(loo[x[0]])
                print("---> Data is [{}, {}, {}] and {} <---".format(x1, x2, x3, An))
        ...
        start_new_thread(trustclient, ('192.168.53.7', ))
