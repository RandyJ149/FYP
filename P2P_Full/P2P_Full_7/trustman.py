...
class Networking():
    def start(self):
        ...
        def trustman():
            ...
            res = [0, 0, 0, 0]
            while True:
                res1 = [item * (ts[0]/4) for item in s1.get()]
                res2 = [item * (ts[1]/4) for item in s2.get()]
                res3 = [item * (ts[2]/4) for item in s3.get()]
                res4 = [item * (ts[3]/4) for item in s4.get()]
                for i in range(4):
